...
# Add the ACRL directory to the Python path
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "../ACRL")))

# Import the specific function from lap_info
